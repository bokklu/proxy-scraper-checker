...
class PldownChecker:
    ...
    async def check_proxies(self):
        ...
        http_proxies_file = open("pldown-proxies-http.txt", "r")
        https_proxies_file = open("pldown-proxies-https.txt", "r")
        socks4_proxies_file = open("pldown-proxies-socks4.txt", "r")
        socks5_proxies_file = open("pldown-proxies-socks5.txt", "r")
